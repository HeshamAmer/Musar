...
/**
 * 
 * _id of the app activity in mobile db
 * appID the id of the app (in application table)
 * the time that the user started using this app
 * the duration of using the app
 *
 */
